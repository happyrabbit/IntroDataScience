...
Model interpretability is critical if you want to understand the drivers of an outcome of interest or relationship among variables. For example, product managers often need to prioritize a list of features by user preference. Choice modeling is a common method for this problem which allows you to explain the drivers behind users' decisions on using/purchasing a product. 
