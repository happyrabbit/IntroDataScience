...
\caption{Shewed Distribution}(\#fig:skew)
\end{figure}
...
\caption{Box-Cox Transformation}(\#fig:bc)
\end{figure}
...
\caption{Use basic visualization to check outliers}(\#fig:scm)
\end{figure}
...
\caption{Spatial sign transformation}(\#fig:sst)
\end{figure}
...
\caption{Correlation Matrix}(\#fig:corp)
\end{figure}
