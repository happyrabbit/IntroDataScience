...
The analytical process is aggregated instead of independent steps. Current step shed new light on what to do next. Sometimes you also need to go back to fix something in the previous steps. For example, you may need to check those negative expense value.
