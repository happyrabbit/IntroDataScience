...
A newer lasso technique to perform model selection and parameter estimation is the group lasso algorithm of Meier et al. [@Meier2008]. Group lasso provides an attractive solution to this question because of its ability to achieve group variable selection and stabilize parameter estimates at the same time. 
