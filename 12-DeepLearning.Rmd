...
You can see the result by plotting the output image. 
...
```{r eggshell conv, fig.cap = "Example of max and mean pooling", out.width="100%", fig.asp=.75, fig.align="center", echo = F}
