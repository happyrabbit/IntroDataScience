...
Why are those outliers? They are outliers conditional on the values of the independent variables. Let us examine the value of expense for samples with the same Q1, Q2, Q3, Q6, and Q8 answers as the 3rd row above. 
...
There are 87 samples with the same value of independent variables. The response variable's (`total_exp`) distribution is:
