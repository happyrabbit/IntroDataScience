...
![Sample of MNIST dataset (https://en.wikipedia.org/wiki/File:MnistExamples.png)](images/MnistExamples.png){width=70%}
...
<!--chapter:end:04-BigDataCloudPlatform.Rmd-->
